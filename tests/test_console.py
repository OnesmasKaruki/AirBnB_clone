...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for testing HBNB command interpreter prompt."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for testingthe HBNB command interpreter help messages."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    ...
    """Unittests for testing HBNB command interpreter exit prompt."""
    def test_quit_exits(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertTrue(HNBCommand().onecmd("quit"))
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for testing HBNB command interpreter create prompt."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for testing HBNB command interpreter show prompt."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for testing HBNB command interpreter destroy prompt."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for testing the HBNB command interpreter update prompt."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests for testing HBNB comand interpreter count method."""
